...
{
    /// <summary> A Class representing a ScalingPlan along with the instance operations that can be performed on it. </summary>
    public partial class ScalingPlan : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="ScalingPlan"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="ScalingPlan"/> class for mocking. </summary>
        protected ScalingPlan()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "ScalingPlan"/> class. </summary>
        ...
        internal ScalingPlan(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<Response<ScalingPlan>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _scalingPlanClientDiagnostics.CreateScope("ScalingPlan.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ScalingPlan> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _scalingPlanClientDiagnostics.CreateScope("ScalingPlan.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _scalingPlanClientDiagnostics.CreateScope("ScalingPlan.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ScalingPlan>> UpdateAsync(PatchableScalingPlanData data, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<ScalingPlan>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));

            using var scope = _scalingPlanClientDiagnostics.CreateScope("ScalingPlan.AddTag");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new ScalingPlan(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<ScalingPlan> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));
        ...
        public virtual async Task<Response<ScalingPlan>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));

            using var scope = _scalingPlanClientDiagnostics.CreateScope("ScalingPlan.SetTags");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Response<ScalingPlan> SetTags(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));
        ...
        public virtual async Task<Response<ScalingPlan>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));

            using var scope = _scalingPlanClientDiagnostics.CreateScope("ScalingPlan.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResource.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<ScalingPlan> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
