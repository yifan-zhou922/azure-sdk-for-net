...
namespace DnsManagementClient
{
    ...
    {
        /// <summary> Generate the resource identifier of a <see cref="RecordSet"/> instance. </summary>
        ...
        internal RecordSet(ArmClient client, RecordSetData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal RecordSet(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _recordSetClientDiagnostics = new ClientDiagnostics("DnsManagementClient", ResourceType.Namespace, DiagnosticOptions);
        ...
        public virtual async Task<Response<RecordSet>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSet.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSet.Delete");
            scope.Start();
            try
            {
                ...
                var operation = new DnsManagementClientArmOperation(response);
        ...
        public virtual async Task<Response<RecordSet>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetClientDiagnostics.CreateScope("RecordSet.Update");
            scope.Start();
            try
            {
                var response = await _recordSetRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "A".ToRecordType(), Id.Name, parameters, ifMatch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new RecordSet(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<RecordSet> Update(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recordSetRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "A".ToRecordType(), Id.Name, parameters, ifMatch, cancellationToken);
                return Response.FromValue(new RecordSet(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
