...
namespace Azure.Analytics.Purview.Catalog
{
    internal partial class PurviewTypesRestClient
    {
        ...
        public PurviewTypesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion = "2022-03-01-preview")
        {
        ...
        internal HttpMessage CreateGetBusinessMetadataDefByGuidRequest(string guid)
        {
        ...
        public async Task<Response<AtlasBusinessMetadataDef>> GetBusinessMetadataDefByGuidAsync(string guid, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
            ...
            using var message = CreateGetBusinessMetadataDefByGuidRequest(guid);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        AtlasBusinessMetadataDef value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = AtlasBusinessMetadataDef.DeserializeAtlasBusinessMetadataDef(document.RootElement);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public Response<AtlasBusinessMetadataDef> GetBusinessMetadataDefByGuid(string guid, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
        ...
        internal HttpMessage CreateGetBusinessMetadataDefByNameRequest(string name)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<AtlasBusinessMetadataDef>> GetBusinessMetadataDefByNameAsync(string name, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
            ...
            using var message = CreateGetBusinessMetadataDefByNameRequest(name);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public Response<AtlasBusinessMetadataDef> GetBusinessMetadataDefByName(string name, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
