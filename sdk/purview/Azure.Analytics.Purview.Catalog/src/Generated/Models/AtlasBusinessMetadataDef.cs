...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    public partial class AtlasBusinessMetadataDef : AtlasStructDef
    {
        /// <summary> Initializes a new instance of AtlasBusinessMetadataDef. </summary>
        ...
        internal AtlasBusinessMetadataDef(TypeCategory? category, float? createTime, string createdBy, DateFormat dateFormatter, string description, string guid, string name, IDictionary<string, string> options, string serviceType, string typeVersion, float? updateTime, string updatedBy, float? version, string lastModifiedTS, IList<AtlasAttributeDef> attributeDefs) : base(category, createTime, createdBy, dateFormatter, description, guid, name, options, serviceType, typeVersion, updateTime, updatedBy, version, lastModifiedTS, attributeDefs)
        {
        }
    }
}
