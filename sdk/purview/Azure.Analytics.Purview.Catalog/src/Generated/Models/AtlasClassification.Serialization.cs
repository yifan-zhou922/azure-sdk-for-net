...
{
    [JsonConverter(typeof(AtlasClassificationConverter))]
    public partial class AtlasClassification : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasClassificationConverter : JsonConverter<AtlasClassification>
        {
            public override void Write(Utf8JsonWriter writer, AtlasClassification model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasClassification Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
