...
{
    [JsonConverter(typeof(AtlasGlossaryBaseObjectConverter))]
    public partial class AtlasGlossaryBaseObject : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasGlossaryBaseObjectConverter : JsonConverter<AtlasGlossaryBaseObject>
        {
            public override void Write(Utf8JsonWriter writer, AtlasGlossaryBaseObject model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasGlossaryBaseObject Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeAtlasGlossaryBaseObject(document.RootElement);
            }
        }
    }
}
