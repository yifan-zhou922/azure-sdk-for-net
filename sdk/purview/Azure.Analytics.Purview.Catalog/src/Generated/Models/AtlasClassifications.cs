...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    public partial class AtlasClassifications : PList
    {
        ...
        internal AtlasClassifications(IList<object> list, int? pageSize, string sortBy, SortType? sortType, long? startIndex, long? totalCount) : base(list, pageSize, sortBy, sortType, startIndex, totalCount)
        {
        }
    }
}
