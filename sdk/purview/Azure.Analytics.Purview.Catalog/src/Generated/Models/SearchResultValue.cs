...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    public partial class SearchResultValue
    {
        ...
        internal SearchResultValue(float? searchScore, SearchHighlights searchHighlights, string searchText, string description, string id, string name, string owner, string qualifiedName, string entityType, IList<string> classification, IList<string> label, IList<TermSearchResultValue> term, IList<ContactSearchResultValue> contact, IList<string> assetType)
        {
