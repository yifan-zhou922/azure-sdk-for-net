...
{
    [JsonConverter(typeof(AtlasGlossaryCategoryConverter))]
    public partial class AtlasGlossaryCategory : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasGlossaryCategoryConverter : JsonConverter<AtlasGlossaryCategory>
        {
            public override void Write(Utf8JsonWriter writer, AtlasGlossaryCategory model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasGlossaryCategory Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
