...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    public partial class TimeZone : IUtf8JsonSerializable
    {
        ...
        internal partial class TimeZoneConverter : JsonConverter<TimeZone>
        {
            public override void Write(Utf8JsonWriter writer, TimeZone model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override TimeZone Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
