...
{
    [JsonConverter(typeof(AtlasEntityConverter))]
    public partial class AtlasEntity : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("businessAttributes");
                writer.WriteStartObject();
        ...
        {
            Optional<IDictionary<string, object>> businessAttributes = default;
            ...
            {
                if (property.NameEquals("businessAttributes"))
                {
                ...
                if (property.NameEquals("customAttributes"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
                ...
                if (property.NameEquals("isIncomplete"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
