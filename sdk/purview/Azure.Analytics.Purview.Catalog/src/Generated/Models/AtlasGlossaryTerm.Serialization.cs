...
{
    [JsonConverter(typeof(AtlasGlossaryTermConverter))]
    public partial class AtlasGlossaryTerm : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasGlossaryTermConverter : JsonConverter<AtlasGlossaryTerm>
        {
            public override void Write(Utf8JsonWriter writer, AtlasGlossaryTerm model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasGlossaryTerm Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
