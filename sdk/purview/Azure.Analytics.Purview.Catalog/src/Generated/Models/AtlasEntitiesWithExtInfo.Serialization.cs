...
{
    [JsonConverter(typeof(AtlasEntitiesWithExtInfoConverter))]
    public partial class AtlasEntitiesWithExtInfo : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasEntitiesWithExtInfoConverter : JsonConverter<AtlasEntitiesWithExtInfo>
        {
            public override void Write(Utf8JsonWriter writer, AtlasEntitiesWithExtInfo model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasEntitiesWithExtInfo Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
