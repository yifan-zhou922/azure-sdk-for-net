...
{
    [JsonConverter(typeof(AtlasExtraTypeDefConverter))]
    public partial class AtlasExtraTypeDef : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasExtraTypeDefConverter : JsonConverter<AtlasExtraTypeDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasExtraTypeDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasExtraTypeDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeAtlasExtraTypeDef(document.RootElement);
            }
        }
    }
}
