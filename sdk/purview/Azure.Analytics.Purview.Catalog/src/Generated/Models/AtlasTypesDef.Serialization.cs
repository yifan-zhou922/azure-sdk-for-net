...
{
    [JsonConverter(typeof(AtlasTypesDefConverter))]
    public partial class AtlasTypesDef : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("businessMetadataDefs");
        ...
        internal static AtlasTypesDef DeserializeAtlasTypesDef(JsonElement element)
        {
            ...
            {
                if (property.NameEquals("businessMetadataDefs"))
                {
        ...
        internal partial class AtlasTypesDefConverter : JsonConverter<AtlasTypesDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasTypesDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasTypesDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
