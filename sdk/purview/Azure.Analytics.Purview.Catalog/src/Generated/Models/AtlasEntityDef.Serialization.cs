...
{
    [JsonConverter(typeof(AtlasEntityDefConverter))]
    public partial class AtlasEntityDef : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasEntityDefConverter : JsonConverter<AtlasEntityDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasEntityDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasEntityDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
