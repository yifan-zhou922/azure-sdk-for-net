...
{
    [JsonConverter(typeof(AtlasAttributeDefConverter))]
    public partial class AtlasAttributeDef : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasAttributeDefConverter : JsonConverter<AtlasAttributeDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasAttributeDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasAttributeDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
