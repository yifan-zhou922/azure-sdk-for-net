...
{
    [JsonConverter(typeof(AtlasTypeDefConverter))]
    public partial class AtlasTypeDef : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasTypeDefConverter : JsonConverter<AtlasTypeDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasTypeDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasTypeDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
