...
{
    [JsonConverter(typeof(AtlasTermAssignmentHeaderConverter))]
    public partial class AtlasTermAssignmentHeader : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasTermAssignmentHeaderConverter : JsonConverter<AtlasTermAssignmentHeader>
        {
            public override void Write(Utf8JsonWriter writer, AtlasTermAssignmentHeader model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasTermAssignmentHeader Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
