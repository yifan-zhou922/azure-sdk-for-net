...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    public partial class SuggestResultValue
    {
        ...
        internal SuggestResultValue(float? searchScore, string searchText, string description, string id, string name, string owner, string qualifiedName, string entityType, IList<string> classification, IList<string> label, IList<TermSearchResultValue> term, IList<ContactSearchResultValue> contact, IList<string> assetType)
        {
