...
{
    [JsonConverter(typeof(AtlasRelationshipAttributeDefConverter))]
    public partial class AtlasRelationshipAttributeDef : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasRelationshipAttributeDefConverter : JsonConverter<AtlasRelationshipAttributeDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasRelationshipAttributeDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasRelationshipAttributeDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
