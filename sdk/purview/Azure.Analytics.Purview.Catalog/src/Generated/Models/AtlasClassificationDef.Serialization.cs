...
{
    [JsonConverter(typeof(AtlasClassificationDefConverter))]
    public partial class AtlasClassificationDef : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasClassificationDefConverter : JsonConverter<AtlasClassificationDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasClassificationDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasClassificationDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
