...
{
    [JsonConverter(typeof(AtlasBusinessMetadataDefConverter))]
    public partial class AtlasBusinessMetadataDef : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasBusinessMetadataDefConverter : JsonConverter<AtlasBusinessMetadataDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasBusinessMetadataDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasBusinessMetadataDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
