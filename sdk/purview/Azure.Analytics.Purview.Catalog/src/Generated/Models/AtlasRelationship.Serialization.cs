...
{
    [JsonConverter(typeof(AtlasRelationshipConverter))]
    public partial class AtlasRelationship : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasRelationshipConverter : JsonConverter<AtlasRelationship>
        {
            public override void Write(Utf8JsonWriter writer, AtlasRelationship model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasRelationship Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
