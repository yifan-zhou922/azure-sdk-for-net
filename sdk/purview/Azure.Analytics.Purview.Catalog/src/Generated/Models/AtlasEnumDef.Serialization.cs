...
{
    [JsonConverter(typeof(AtlasEnumDefConverter))]
    public partial class AtlasEnumDef : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasEnumDefConverter : JsonConverter<AtlasEnumDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasEnumDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasEnumDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeAtlasEnumDef(document.RootElement);
            }
        }
    }
}
