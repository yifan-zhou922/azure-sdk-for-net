...
{
    [JsonConverter(typeof(NumberFormatConverter))]
    public partial class NumberFormat : IUtf8JsonSerializable
    {
        ...
        internal partial class NumberFormatConverter : JsonConverter<NumberFormat>
        {
            public override void Write(Utf8JsonWriter writer, NumberFormat model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override NumberFormat Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
