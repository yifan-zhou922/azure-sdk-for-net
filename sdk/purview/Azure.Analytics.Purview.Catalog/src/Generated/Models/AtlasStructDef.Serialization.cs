...
{
    [JsonConverter(typeof(AtlasStructDefConverter))]
    public partial class AtlasStructDef : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasStructDefConverter : JsonConverter<AtlasStructDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasStructDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasStructDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
