...
{
    [JsonConverter(typeof(AtlasGlossaryConverter))]
    public partial class AtlasGlossary : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasGlossaryConverter : JsonConverter<AtlasGlossary>
        {
            public override void Write(Utf8JsonWriter writer, AtlasGlossary model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasGlossary Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
