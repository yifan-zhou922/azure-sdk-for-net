...
{
    [JsonConverter(typeof(PListConverter))]
    public partial class PList : IUtf8JsonSerializable
    {
        ...
        internal partial class PListConverter : JsonConverter<PList>
        {
            public override void Write(Utf8JsonWriter writer, PList model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override PList Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializePList(document.RootElement);
            }
        }
    }
}
