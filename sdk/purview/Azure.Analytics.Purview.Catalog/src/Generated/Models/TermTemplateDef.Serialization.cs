...
{
    [JsonConverter(typeof(TermTemplateDefConverter))]
    public partial class TermTemplateDef : IUtf8JsonSerializable
    {
        ...
        internal partial class TermTemplateDefConverter : JsonConverter<TermTemplateDef>
        {
            public override void Write(Utf8JsonWriter writer, TermTemplateDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override TermTemplateDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeTermTemplateDef(document.RootElement);
            }
        }
    }
}
