...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    public partial class AtlasEntity : AtlasStruct
    {
        ...
        public AtlasEntity()
        {
            BusinessAttributes = new ChangeTrackingDictionary<string, object>();
        ...
        internal AtlasEntity(IDictionary<string, object> attributes, string typeName, string lastModifiedTS, IDictionary<string, object> businessAttributes, IList<AtlasClassification> classifications, float? createTime, string createdBy, IDictionary<string, string> customAttributes, string guid, string homeId, bool? isIncomplete, IList<string> labels, IList<AtlasTermAssignmentHeader> meanings, float? provenanceType, bool? proxy, IDictionary<string, object> relationshipAttributes, Status? status, float? updateTime, string updatedBy, float? version, string source, IDictionary<string, object> sourceDetails, IDictionary<string, IList<ContactBasic>> contacts) : base(attributes, typeName, lastModifiedTS)
        {
        ...
        /// <summary> Business Attributes. </summary>
        public IDictionary<string, object> BusinessAttributes { get; }
