...
{
    [JsonConverter(typeof(SuggestResultValueConverter))]
    public partial class SuggestResultValue : IUtf8JsonSerializable
    {
        ...
        internal partial class SuggestResultValueConverter : JsonConverter<SuggestResultValue>
        {
            public override void Write(Utf8JsonWriter writer, SuggestResultValue model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override SuggestResultValue Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
