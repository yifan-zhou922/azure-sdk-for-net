...
{
    [JsonConverter(typeof(AtlasRelationshipDefConverter))]
    public partial class AtlasRelationshipDef : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasRelationshipDefConverter : JsonConverter<AtlasRelationshipDef>
        {
            public override void Write(Utf8JsonWriter writer, AtlasRelationshipDef model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasRelationshipDef Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
