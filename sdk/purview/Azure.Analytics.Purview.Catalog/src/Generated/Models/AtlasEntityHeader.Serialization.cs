...
{
    [JsonConverter(typeof(AtlasEntityHeaderConverter))]
    public partial class AtlasEntityHeader : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasEntityHeaderConverter : JsonConverter<AtlasEntityHeader>
        {
            public override void Write(Utf8JsonWriter writer, AtlasEntityHeader model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasEntityHeader Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
