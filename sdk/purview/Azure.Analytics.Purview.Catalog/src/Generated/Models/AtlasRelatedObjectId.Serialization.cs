...
{
    [JsonConverter(typeof(AtlasRelatedObjectIdConverter))]
    public partial class AtlasRelatedObjectId : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasRelatedObjectIdConverter : JsonConverter<AtlasRelatedObjectId>
        {
            public override void Write(Utf8JsonWriter writer, AtlasRelatedObjectId model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasRelatedObjectId Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
