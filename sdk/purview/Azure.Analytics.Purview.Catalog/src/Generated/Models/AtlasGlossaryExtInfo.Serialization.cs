...
{
    [JsonConverter(typeof(AtlasGlossaryExtInfoConverter))]
    public partial class AtlasGlossaryExtInfo : IUtf8JsonSerializable
    {
        ...
        internal partial class AtlasGlossaryExtInfoConverter : JsonConverter<AtlasGlossaryExtInfo>
        {
            public override void Write(Utf8JsonWriter writer, AtlasGlossaryExtInfo model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override AtlasGlossaryExtInfo Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
