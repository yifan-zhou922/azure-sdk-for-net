...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    public partial class DateFormat : IUtf8JsonSerializable
    {
        ...
        internal partial class DateFormatConverter : JsonConverter<DateFormat>
        {
            public override void Write(Utf8JsonWriter writer, DateFormat model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override DateFormat Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
            {
