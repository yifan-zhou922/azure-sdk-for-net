...
{
    internal partial class PurviewGlossariesRestClient
    {
        ...
        /// <summary> Initializes a new instance of PurviewGlossariesRestClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="endpoint"> The catalog endpoint of your Purview account. Example: https://{accountName}.purview.azure.com. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="clientDiagnostics"/>, <paramref name="pipeline"/>, <paramref name="endpoint"/> or <paramref name="apiVersion"/> is null. </exception>
        public PurviewGlossariesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion = "2022-03-01-preview")
        {
        ...
        internal HttpMessage CreateGetGlossaryTermRequest(string termGuid, bool? includeTermHierarchy, IEnumerable<string> excludeRelationshipTypeList)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<AtlasGlossaryTerm>> GetGlossaryTermAsync(string termGuid, bool? includeTermHierarchy = null, IEnumerable<string> excludeRelationshipTypeList = null, CancellationToken cancellationToken = default)
        {
            if (termGuid == null)
            {
            ...
            using var message = CreateGetGlossaryTermRequest(termGuid, includeTermHierarchy, excludeRelationshipTypeList);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="termGuid"/> is null. </exception>
        public Response<AtlasGlossaryTerm> GetGlossaryTerm(string termGuid, bool? includeTermHierarchy = null, IEnumerable<string> excludeRelationshipTypeList = null, CancellationToken cancellationToken = default)
        {
            if (termGuid == null)
            {
                throw new ArgumentNullException(nameof(termGuid));
        ...
        internal HttpMessage CreateUpdateGlossaryTermRequest(string termGuid, AtlasGlossaryTerm glossaryTerm, bool? includeTermHierarchy)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<Response<AtlasGlossaryTerm>> UpdateGlossaryTermAsync(string termGuid, AtlasGlossaryTerm glossaryTerm, bool? includeTermHierarchy = null, CancellationToken cancellationToken = default)
        {
            if (termGuid == null)
            {
                throw new ArgumentNullException(nameof(termGuid));
            ...
            using var message = CreateUpdateGlossaryTermRequest(termGuid, glossaryTerm, includeTermHierarchy);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="termGuid"/> or <paramref name="glossaryTerm"/> is null. </exception>
        public Response<AtlasGlossaryTerm> UpdateGlossaryTerm(string termGuid, AtlasGlossaryTerm glossaryTerm, bool? includeTermHierarchy = null, CancellationToken cancellationToken = default)
        {
            if (termGuid == null)
            {
                throw new ArgumentNullException(nameof(termGuid));
