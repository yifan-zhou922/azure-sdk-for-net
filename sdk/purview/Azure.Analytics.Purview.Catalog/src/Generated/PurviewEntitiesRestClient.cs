...
{
    internal partial class PurviewEntitiesRestClient
    {
        ...
        /// <summary> Initializes a new instance of PurviewEntitiesRestClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="endpoint"> The catalog endpoint of your Purview account. Example: https://{accountName}.purview.azure.com. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="clientDiagnostics"/>, <paramref name="pipeline"/> or <paramref name="endpoint"/> is null. </exception>
        public PurviewEntitiesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint)
        {
        ...
        internal HttpMessage CreateDeleteBusinessMetadataRequest(string guid, IDictionary<string, object> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public async Task<Response> DeleteBusinessMetadataAsync(string guid, IDictionary<string, object> body = null, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
            ...
            using var message = CreateDeleteBusinessMetadataRequest(guid, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public Response DeleteBusinessMetadata(string guid, IDictionary<string, object> body = null, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
        ...
        internal HttpMessage CreateAddOrUpdateBusinessMetadataRequest(string guid, bool? isOverwrite, IDictionary<string, object> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public async Task<Response> AddOrUpdateBusinessMetadataAsync(string guid, bool? isOverwrite = null, IDictionary<string, object> body = null, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
            ...
            using var message = CreateAddOrUpdateBusinessMetadataRequest(guid, isOverwrite, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public Response AddOrUpdateBusinessMetadata(string guid, bool? isOverwrite = null, IDictionary<string, object> body = null, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
        ...
        internal HttpMessage CreateDeleteBusinessMetadataAttributesRequest(string bmName, string guid, IDictionary<string, object> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="bmName"/> or <paramref name="guid"/> is null. </exception>
        public async Task<Response> DeleteBusinessMetadataAttributesAsync(string bmName, string guid, IDictionary<string, object> body = null, CancellationToken cancellationToken = default)
        {
            if (bmName == null)
            {
            ...
            using var message = CreateDeleteBusinessMetadataAttributesRequest(bmName, guid, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="bmName"/> or <paramref name="guid"/> is null. </exception>
        public Response DeleteBusinessMetadataAttributes(string bmName, string guid, IDictionary<string, object> body = null, CancellationToken cancellationToken = default)
        {
            if (bmName == null)
            {
                throw new ArgumentNullException(nameof(bmName));
        ...
        internal HttpMessage CreateAddOrUpdateBusinessMetadataAttributesRequest(string bmName, string guid, IDictionary<string, object> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="bmName"/> or <paramref name="guid"/> is null. </exception>
        public async Task<Response> AddOrUpdateBusinessMetadataAttributesAsync(string bmName, string guid, IDictionary<string, object> body = null, CancellationToken cancellationToken = default)
        {
            if (bmName == null)
            {
                throw new ArgumentNullException(nameof(bmName));
            ...
            using var message = CreateAddOrUpdateBusinessMetadataAttributesRequest(bmName, guid, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="bmName"/> or <paramref name="guid"/> is null. </exception>
        public Response AddOrUpdateBusinessMetadataAttributes(string bmName, string guid, IDictionary<string, object> body = null, CancellationToken cancellationToken = default)
        {
            if (bmName == null)
            {
                throw new ArgumentNullException(nameof(bmName));
        ...
        internal HttpMessage CreateGetSampleBusinessMetadataTemplateRequest()
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<Stream>> GetSampleBusinessMetadataTemplateAsync(CancellationToken cancellationToken = default)
        {
            using var message = CreateGetSampleBusinessMetadataTemplateRequest();
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <summary> Get the sample Template for uploading/creating bulk BusinessMetaData. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<Stream> GetSampleBusinessMetadataTemplate(CancellationToken cancellationToken = default)
        {
            using var message = CreateGetSampleBusinessMetadataTemplateRequest();
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
        ...
        internal HttpMessage CreateImportBusinessMetadataRequest(Stream uploadedInputStream)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
            ...
            {
                content.Add(RequestContent.Create(uploadedInputStream), "uploadedInputStream", null);
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<BulkImportResponse>> ImportBusinessMetadataAsync(Stream uploadedInputStream = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateImportBusinessMetadataRequest(uploadedInputStream);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        BulkImportResponse value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = BulkImportResponse.DeserializeBulkImportResponse(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await ClientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="uploadedInputStream"> InputStream of file. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<BulkImportResponse> ImportBusinessMetadata(Stream uploadedInputStream = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateImportBusinessMetadataRequest(uploadedInputStream);
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
        ...
        internal HttpMessage CreateDeleteLabelsRequest(string guid, IEnumerable<string> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public async Task<Response> DeleteLabelsAsync(string guid, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
            ...
            using var message = CreateDeleteLabelsRequest(guid, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public Response DeleteLabels(string guid, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
        ...
        internal HttpMessage CreateSetLabelsRequest(string guid, IEnumerable<string> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public async Task<Response> SetLabelsAsync(string guid, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
            ...
            using var message = CreateSetLabelsRequest(guid, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public Response SetLabels(string guid, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
        ...
        internal HttpMessage CreateAddLabelRequest(string guid, IEnumerable<string> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public async Task<Response> AddLabelAsync(string guid, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
            ...
            using var message = CreateAddLabelRequest(guid, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        public Response AddLabel(string guid, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (guid == null)
            {
                throw new ArgumentNullException(nameof(guid));
        ...
        internal HttpMessage CreateDeleteLabelsByUniqueAttributeRequest(string typeName, string attrQualifiedName, IEnumerable<string> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="typeName"/> is null. </exception>
        public async Task<Response> DeleteLabelsByUniqueAttributeAsync(string typeName, string attrQualifiedName = null, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (typeName == null)
            {
                throw new ArgumentNullException(nameof(typeName));
            ...
            using var message = CreateDeleteLabelsByUniqueAttributeRequest(typeName, attrQualifiedName, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="typeName"/> is null. </exception>
        public Response DeleteLabelsByUniqueAttribute(string typeName, string attrQualifiedName = null, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (typeName == null)
            {
                throw new ArgumentNullException(nameof(typeName));
        ...
        internal HttpMessage CreateSetLabelsByUniqueAttributeRequest(string typeName, string attrQualifiedName, IEnumerable<string> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="typeName"/> is null. </exception>
        public async Task<Response> SetLabelsByUniqueAttributeAsync(string typeName, string attrQualifiedName = null, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (typeName == null)
            {
                throw new ArgumentNullException(nameof(typeName));
            ...
            using var message = CreateSetLabelsByUniqueAttributeRequest(typeName, attrQualifiedName, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="typeName"/> is null. </exception>
        public Response SetLabelsByUniqueAttribute(string typeName, string attrQualifiedName = null, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (typeName == null)
            {
                throw new ArgumentNullException(nameof(typeName));
        ...
        internal HttpMessage CreateAddLabelsByUniqueAttributeRequest(string typeName, string attrQualifiedName, IEnumerable<string> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="typeName"/> is null. </exception>
        public async Task<Response> AddLabelsByUniqueAttributeAsync(string typeName, string attrQualifiedName = null, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (typeName == null)
            {
                throw new ArgumentNullException(nameof(typeName));
            ...
            using var message = CreateAddLabelsByUniqueAttributeRequest(typeName, attrQualifiedName, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="typeName"/> is null. </exception>
        public Response AddLabelsByUniqueAttribute(string typeName, string attrQualifiedName = null, IEnumerable<string> body = null, CancellationToken cancellationToken = default)
        {
            if (typeName == null)
            {
                throw new ArgumentNullException(nameof(typeName));
