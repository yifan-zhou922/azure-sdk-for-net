...
namespace Azure.ResourceManager.Network
{
    ...
    {
        /// <summary> Generate the resource identifier of a <see cref="Route"/> instance. </summary>
        ...
        internal Route(ArmClient client, RouteData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        internal Route(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _routeClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ResourceType.Namespace, DiagnosticOptions);
        ...
        public virtual async Task<Response<Route>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _routeClientDiagnostics.CreateScope("Route.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _routeClientDiagnostics.CreateScope("Route.Delete");
            scope.Start();
            try
            {
