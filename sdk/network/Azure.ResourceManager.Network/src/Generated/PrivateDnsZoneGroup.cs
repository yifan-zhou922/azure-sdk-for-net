...
namespace Azure.ResourceManager.Network
{
    ...
    {
        /// <summary> Generate the resource identifier of a <see cref="PrivateDnsZoneGroup"/> instance. </summary>
        ...
        internal PrivateDnsZoneGroup(ArmClient client, PrivateDnsZoneGroupData data) : this(client, new ResourceIdentifier(data.Id))
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<PrivateDnsZoneGroup>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _privateDnsZoneGroupClientDiagnostics.CreateScope("PrivateDnsZoneGroup.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _privateDnsZoneGroupClientDiagnostics.CreateScope("PrivateDnsZoneGroup.Delete");
            scope.Start();
            try
            {
