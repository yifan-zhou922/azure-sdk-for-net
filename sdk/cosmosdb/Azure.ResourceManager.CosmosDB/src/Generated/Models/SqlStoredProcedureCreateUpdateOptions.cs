...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlStoredProcedureCreateUpdateOptions : TrackedResourceData
    {
        ...
        internal SqlStoredProcedureCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SqlStoredProcedureResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
