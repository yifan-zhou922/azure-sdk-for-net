...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinGraphCreateUpdateOptions : TrackedResourceData
    {
        ...
        public GremlinGraphCreateUpdateOptions(AzureLocation location, GremlinGraphResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal GremlinGraphCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, GremlinGraphResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
