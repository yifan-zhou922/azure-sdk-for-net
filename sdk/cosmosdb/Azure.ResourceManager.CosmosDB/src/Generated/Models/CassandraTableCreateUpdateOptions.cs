...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraTableCreateUpdateOptions : TrackedResourceData
    {
        ...
        internal CassandraTableCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, CassandraTableResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
