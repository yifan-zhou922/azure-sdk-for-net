...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlUserDefinedFunctionCreateUpdateOptions : TrackedResourceData
    {
        ...
        internal SqlUserDefinedFunctionCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SqlUserDefinedFunctionResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
