...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraKeyspaceCreateUpdateOptions : TrackedResourceData
    {
        ...
        internal CassandraKeyspaceCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, CassandraKeyspaceResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
