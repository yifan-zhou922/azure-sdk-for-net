...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlContainerCreateUpdateOptions : TrackedResourceData
    {
        ...
        public SqlContainerCreateUpdateOptions(AzureLocation location, SqlContainerResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlContainerCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SqlContainerResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
