...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinDatabaseCreateUpdateOptions : TrackedResourceData
    {
        ...
        internal GremlinDatabaseCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, GremlinDatabaseResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
