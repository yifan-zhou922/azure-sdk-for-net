...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDatabaseCreateUpdateOptions : TrackedResourceData
    {
        ...
        internal SqlDatabaseCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SqlDatabaseResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
