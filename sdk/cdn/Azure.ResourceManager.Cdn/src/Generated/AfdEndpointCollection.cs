...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdEndpointCollection : ArmCollection, IEnumerable<AfdEndpoint>, IAsyncEnumerable<AfdEndpoint>
    {
        ...
        public virtual async Task<ArmOperation<AfdEndpoint>> CreateOrUpdateAsync(WaitUntil waitUntil, string endpointName, AfdEndpointData endpointInput, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CdnArmOperation<AfdEndpoint>(new AfdEndpointOperationSource(Client), _afdEndpointClientDiagnostics, Pipeline, _afdEndpointRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, endpointName, endpointInput).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        /// <exception cref="ArgumentException"> <paramref name="endpointName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="endpointName"/> or <paramref name="endpointInput"/> is null. </exception>
        public virtual ArmOperation<AfdEndpoint> CreateOrUpdate(WaitUntil waitUntil, string endpointName, AfdEndpointData endpointInput, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(endpointName, nameof(endpointName));
            Argument.AssertNotNull(endpointInput, nameof(endpointInput));
