...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class StorageQueue : ArmResource
    {
        ...
        internal StorageQueue(ArmClient client, StorageQueueData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal StorageQueue(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<Response<StorageQueue>> UpdateAsync(StorageQueueData queue, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _storageQueueQueueClientDiagnostics.CreateScope("StorageQueue.Update");
            scope.Start();
            try
            {
