...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class EventHubCluster : ArmResource
    {
        ...
        public virtual async Task<Response<EventHubCluster>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<ArmOperation<EventHubCluster>> UpdateAsync(WaitUntil waitUntil, EventHubClusterData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EventHubsArmOperation<EventHubCluster>(new EventHubClusterOperationSource(Client), _eventHubClusterClientDiagnostics, Pipeline, _eventHubClusterRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual ArmOperation<EventHubCluster> Update(WaitUntil waitUntil, EventHubClusterData parameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
        ...
        public virtual async Task<Response<EventHubCluster>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<EventHubCluster>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<EventHubCluster>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
