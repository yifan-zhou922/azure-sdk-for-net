...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class EventHubClusterCollection : ArmCollection, IEnumerable<EventHubCluster>, IAsyncEnumerable<EventHubCluster>
    {
        ...
        public virtual async Task<ArmOperation<EventHubCluster>> CreateOrUpdateAsync(WaitUntil waitUntil, string clusterName, EventHubClusterData parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="clusterName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="clusterName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual ArmOperation<EventHubCluster> CreateOrUpdate(WaitUntil waitUntil, string clusterName, EventHubClusterData parameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(clusterName, nameof(clusterName));
            Argument.AssertNotNull(parameters, nameof(parameters));
